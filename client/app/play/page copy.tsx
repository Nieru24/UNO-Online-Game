...
function GameContent() {
  ...
  const endTurn = () => {
    ...
    if (rotation === 0) {
      nextPlayerTurnIndex = (playerTurnIndex + 1) % totalPlayers;
    } else {
      nextPlayerTurnIndex = (playerTurnIndex - 1 + totalPlayers) % totalPlayers;
    }

    setPlayerTurnIndex(nextPlayerTurnIndex);
    console.log("Next Player Turn Index:", nextPlayerTurnIndex);
    console.log("Next Player:", shuffledPlayers[nextPlayerTurnIndex]);
